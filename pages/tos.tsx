...
import ToSstyle from '../styles/ToS.module.css';
...
const ToS: NextPage = () => {
	return (
		<div>
			...
			<main>
				<img src='/moderator.png' className={ToSstyle.tosimg} alt='moderator'></img>
				<h1 className={`title ${ToSstyle.tos}`}>
					<span className={ToSstyle.tostext}>Terms of Services</span>
				</h1>

				<div className='page container'>
					<p>The Muploader website located at https://github.com/xHyroM/Shortener is a copyrighted work belonging to xHyroM. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
					...
					<h2 className='subtitle'>Access to the Site</h2>
					...
					<h2 className='subtitle'>Copyright Policy.</h2>
					...
					<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: email@example.com. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
